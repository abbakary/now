...
export default function PricingManagement() {
  ...
  const [discountRules, setDiscountRules] =
    useState<DiscountRule[]>(mockDiscountRules);
  ...
  const pricingStats = useMemo(() => {
    ...
    const totalApplications = pricingRules.reduce(
      (sum, r) => sum + r.timesApplied,
      0,
    );
    const totalRevenue = pricingRules.reduce(
      (sum, r) => sum + r.totalRevenue,
      0,
    );
    const totalDiscounts = discountRules.filter((d) => d.isActive).length;
    const totalSavings = discountRules.reduce(
      (sum, d) => sum + d.totalSavings,
      0,
    );
  ...
  const handleBulkUpdate = useCallback(async () => {
    try {
      if (
        !bulkUpdateForm.productIds.length ||
        !bulkUpdateForm.reason ||
      ...
      success(
        `Bulk price update applied to ${bulkUpdateForm.productIds.length} products`,
      );
      setBulkUpdateForm({
        productIds: [],
        updateType: "markup",
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage pricing rules, tax rates, and discount policies across all
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {pricingStats.totalApplications.toLocaleString()}
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">
              UGX {pricingStats.totalRevenue.toLocaleString()}
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-orange-600">
              UGX {pricingStats.totalSavings.toLocaleString()}
            </div>
          </CardContent>
        </Card>
                  ...
                  <div className="grid gap-4 md:grid-cols-4">
                    <div className="text-center p-3 bg-blue-50 rounded-lg">
                      <div className="font-bold text-blue-600 text-lg">
                        {rule.type === "markup" || rule.type === "margin"
                          ? `${rule.value}%`
                          : rule.type === "fixed"
                            ? `UGX ${rule.value.toLocaleString()}`
                            : "Tiered"}
                      </div>
                    ...
                    <div className="text-center p-3 bg-purple-50 rounded-lg">
                      <div className="font-bold text-purple-600 text-lg">
                        UGX {rule.totalRevenue.toLocaleString()}
                      </div>
                      <p className="text-xs text-gray-600">Revenue Impact</p>
                    </div>
                    <div className="text-center p-3 bg-orange-50 rounded-lg">
                      <div className="font-bold text-orange-600 text-lg capitalize">
                        {rule.roundingRule.replace("_", " ")}
                      </div>
              ...
              <Card key={discount.id}>
                ...
                <CardContent>
                  <div className="grid gap-4 md:grid-cols-4">
                    <div className="text-center p-3 bg-blue-50 rounded-lg">
                      <div className="font-bold text-blue-600 text-lg">
                        {discount.type === "percentage"
                          ? `${discount.value}%`
                          : `UGX ${discount.value.toLocaleString()}`}
                      </div>
                    ...
                    <div className="text-center p-3 bg-purple-50 rounded-lg">
                      <div className="font-bold text-purple-600 text-lg">
                        UGX {discount.totalSavings.toLocaleString()}
                      </div>
                    ...
                    <div className="text-center p-3 bg-orange-50 rounded-lg">
                      <div className="font-bold text-orange-600 text-lg">
                        {discount.maxUsage
                          ? `${discount.maxUsage - discount.currentUsage}`
                          : "∞"}
                      </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Revenue impact by pricing rule
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Customer savings by discount rule
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={ruleForm.type}
                  onValueChange={(value) =>
                    setRuleForm((prev) => ({ ...prev, type: value as any }))
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setTaxForm((prev) => ({ ...prev, isDefault: checked }))
                  }
                />
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setTaxForm((prev) => ({ ...prev, isActive: checked }))
                  }
                />
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setDiscountForm((prev) => ({ ...prev, type: value as any }))
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
