...
export default function ServiceManagement() {
  ...
  const [services, setServices] =
    useState<ServiceTemplate[]>(mockServiceTemplates);
  ...
  const serviceStats = useMemo(() => {
    ...
    const avgDuration =
      services.reduce((sum, s) => sum + s.estimatedDuration, 0) / totalServices;
  ...
  const handleAddService = useCallback(async () => {
    try {
      ...
      if (
        services.some(
          (s) => s.name.toLowerCase() === serviceForm.name.toLowerCase(),
        )
      ) {
      ...
      const materialsTotal = serviceForm.requiredMaterials.reduce(
        (sum, m) => sum + m.totalPrice,
        0,
      );
      const profitMargin =
        serviceForm.basePrice > 0
          ? ((serviceForm.basePrice - materialsTotal) / serviceForm.basePrice) *
            100
          : 0;
  ...
  const handleToggleServiceStatus = useCallback(
    async (service: ServiceTemplate) => {
      try {
        ...
        success(
          `Service ${service.name} ${updatedService.isActive ? "activated" : "deactivated"} successfully!`,
        );
      } catch (err) {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Configure service types, templates, and pricing for all service
            offerings
          </p>
        </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid w-full grid-cols-3">
          <TabsTrigger value="services">
            Service Templates ({filteredServices.length})
          </TabsTrigger>
                        ...
                        <TableRow key={service.id}>
                          ...
                          <TableCell>
                            <div className="space-y-1">
                              ...
                              <div className="text-xs text-muted-foreground">
                                Labor: UGX {service.laborRate.toLocaleString()}
                                /hr
                              </div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setServiceForm((prev) => ({ ...prev, difficulty: value }))
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setServiceForm((prev) => ({ ...prev, isPopular: checked }))
                  }
                />
        ...
        <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <div className="space-y-2">
                <Label htmlFor="edit-estimatedDuration">
                  Duration (minutes) *
                </Label>
                <Input
